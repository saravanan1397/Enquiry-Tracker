...
class LeadloopApp extends StatelessWidget {
  const LeadloopApp({super.key, required this.store});
...
class _PromoterHomeScreenState extends State<PromoterHomeScreen> {
  ...
  Future<void> _saveLead() async {
    ...
    final lead = CustomerLead(
      ...
      followUp1: _commentController.text.trim().isEmpty
          ? null
  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        ...
        Text('PROMOTER · BENGALURU CENTRAL',
            style: TextStyle(
        ...
        Container(
          ...
          child: const Row(children: [
            Icon(Icons.cloud_off_outlined, size: 17, color: Color(0xFF9A6800)),
            SizedBox(width: 8),
            Text('Offline · Saved on this device',
                style: TextStyle(color: Color(0xFF9A6800), fontSize: 12))
          ]),
        ),
        ...
        TextField(
            ...
            decoration: const InputDecoration(
                labelText: 'First comment', hintText: 'Optional for now')),
    ...
    return ListView(
      ...
      children: [
        ...
        const Wrap(spacing: 8, runSpacing: 8, children: [
          _FilterChip(label: 'All shops'),
          _FilterChip(label: 'All promoters'),
          _FilterChip(label: 'Any follow-up')
        ]),
...
class _FilterChip extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) =>
      InputChip(label: Text(label), onPressed: () {});
}
