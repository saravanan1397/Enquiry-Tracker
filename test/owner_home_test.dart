...
void main() {
  for (final width in [360.0, 1280.0]) {
    for (final brightness in Brightness.values) {
      testWidgets('Owner cards at $width in $brightness open followups',
          (tester) async {
        ...
        await tester.pumpWidget(MaterialApp(
          ...
          home: Scaffold(
            body: OwnerHome(leads: const [], onFollowup: () => opened = true),
          ),
        ));
        ...
        await tester.tap(find.text('Followup widget'));
